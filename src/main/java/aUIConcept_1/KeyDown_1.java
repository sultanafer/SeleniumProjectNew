...
public class KeyDown_1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//action.sendKeys(Keys.TAB).sendKeys("mahbub")); 
		action.sendKeys(Keys.TAB).sendKeys("Moniq");
		//Enter the password in password field
		action.build().perform(); //perform action
